Feature: Gameplay
  ...
  Scenario: Wait on empty street
    ...
    And I click the "Wait" button until I see "You feel so tired. Why can't coffee be free and abundant? Where have all the 'spressos gone?"
    Then I should have 45 "health"

  Scenario: Enter and exit the cafe
    When I click on the "Enter the cafe" button
    And I click on the "Exit the cafe" button
  ...
  Scenario: Buy an espresso
    When I click on the "Enter the cafe" button
    And I click on the "Buy an espresso" button
    Then I should have 5 "money"
    And I should have 1 "espressocups"

  Scenario: Wait in the cafe
    When I click on the "Enter the cafe" button
    And I click the "Wait" button until I see "You wait. The barista looks at you."
